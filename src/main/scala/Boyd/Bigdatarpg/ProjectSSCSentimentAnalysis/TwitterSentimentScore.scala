...
object TwitterSentimentScore {
  ...
  def main(args: Array[String]) {
    ...
    val sparkConfiguration = new SparkConf().
      setAppName("TwitterSentimentScore").
      setMaster("local[6]")
    ...
    val uselessWords = sparkContext.broadcast(load("/Users/redthegx/SparkMLProjects/sparkmlprojects/src/main/resources/input/stop-words.dat"))
    val positiveWords = sparkContext.broadcast(load("/Users/redthegx/SparkMLProjects/sparkmlprojects/src/main/resources/inputpos-words.dat"))
    val negativeWords = sparkContext.broadcast(load("/Users/redthegx/SparkMLProjects/sparkmlprojects/src/main/resources/input/neg-words.dat"))
