...
//      .config("spark.sql.warehouse.dir", "file:///C:/temp") // Necessary to work around a Windows bug in Spark 2.0.0; omit if you're not on Windows.
      .config("spark.sql.streaming.checkpointLocation", "/Users/redthegx/SparkMLProjects/sparkmlprojects/src/main/resources/checkpoint")
      .getOrCreate()

    setupLogging()

    // Create a stream of text files dumped into the logs directory *** pwd where folder of txt file located
    val rawData = spark.readStream.text("/Users/redthegx/SparkMLProjects/sparkmlprojects/src/main/resources/input/logs")
